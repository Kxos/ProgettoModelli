...
public class ValueBoxBaseUi<T> extends com.google.gwt.user.client.ui.ValueBoxBase<T> implements HasId, HasReadOnly,
    ...
    private final IdMixin<ValueBoxBaseUi<T>> idMixin = new IdMixin<ValueBoxBaseUi<T>>(this);

    private final ErrorHandlerMixin<T> errorHandlerMixin = new ErrorHandlerMixin<T>(this);

    private final BlankValidatorMixin<ValueBoxBaseUi<T>, T> validatorMixin = new BlankValidatorMixin<ValueBoxBaseUi<T>, T>(this,
     ...
     */
    protected ValueBoxBaseUi(final Element elem, final Renderer<T> renderer, final Parser<T> parser) {
