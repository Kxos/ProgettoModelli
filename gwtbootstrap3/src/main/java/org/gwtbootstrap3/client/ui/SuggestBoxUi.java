...
import org.gwtbootstrap3.client.ui.base.ValueBoxBaseUi;
 ...
 */
public class SuggestBoxUi extends com.google.gwt.user.client.ui.SuggestBox implements HasId, HasResponsiveness, HasPlaceholder,
    ...
    private final EnabledMixin<SuggestBoxUi> enabledMixin = new EnabledMixin<SuggestBoxUi>(this);

    private final ErrorHandlerMixin<String> errorHandlerMixin = new ErrorHandlerMixin<String>(this);

    private final IdMixin<SuggestBoxUi> idMixin = new IdMixin<SuggestBoxUi>(this);

    private final BlankValidatorMixin<SuggestBoxUi, String> validatorMixin = new BlankValidatorMixin<SuggestBoxUi, String>(this,
        errorHandlerMixin.getErrorHandler());

    /**
     * Constructor for {@link SuggestBoxUi}. Creates a {@link MultiWordSuggestOracle} and {@link TextBox} to use
     * with this {@link SuggestBoxUi}.
     */
    public SuggestBoxUi() {
    ...
    /**
     * Constructor for {@link SuggestBoxUi}. Creates a {@link TextBox} to use with this {@link SuggestBoxUi}.
     *
     * @param oracle the oracle for this <code>SuggestBox</code>
     */
    public SuggestBoxUi(SuggestOracle oracle) {
        this(oracle, new TextBox());
    }

    /**
     * Constructor for {@link SuggestBoxUi}. The text box will be removed from it's current location and wrapped
     * by the {@link SuggestBoxUi}.
     *
     * @param oracle supplies suggestions based upon the current contents of the text widget
     * @param box the text widget
     */
    public SuggestBoxUi(SuggestOracle oracle, ValueBoxBaseUi<String> box) {
     ...
     */
    public SuggestBoxUi(SuggestOracle oracle, ValueBoxBaseUi<String> box, SuggestionDisplay suggestDisplay) {
