 ...
 * @author Joshua Godi
 */
public class DataGridGwt<T> extends com.google.gwt.user.cellview.client.DataGrid<T> implements HasResponsiveness {
     ...
     */
    public DataGridGwt(final int pageSize) {
     ...
     */
    public DataGridGwt(final int pageSize, final ProvidesKey<T> keyProvider) {
     ...
     */
    public DataGridGwt(final int pageSize, final DataGridGwt.Resources resources) {
     ...
     *                         to disable
     */
    public DataGridGwt(final int pageSize, final Resources resources, final ProvidesKey<T> keyProvider, final Widget loadingIndicator) {
     ...
     *                    object should act as its own key
     */
    public DataGridGwt(final ProvidesKey<T> keyProvider) {
        this(DEFAULT_PAGESIZE, keyProvider);
    }

    private static DataGridGwt.Resources getDefaultResources() {
        if (DEFAULT_RESOURCES == null) {
            final DataGridGwt.Resources dataGridResources = GWT.create(Resources.class);
     ...
     */
    private static class ResourcesAdapter implements DataGridGwt.Resources {
        private final DataGridGwt.Resources resources;
        private final StyleAdapter style;

        public ResourcesAdapter(final DataGridGwt.Resources resources) {
        ...
        @Override
        public DataGridGwt.Style dataGridStyle() {
            return style;
        }
    }

    private static class StyleAdapter implements DataGridGwt.Style {
