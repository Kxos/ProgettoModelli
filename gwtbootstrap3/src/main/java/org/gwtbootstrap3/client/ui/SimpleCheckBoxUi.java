 ...
 */
public class SimpleCheckBoxUi extends com.google.gwt.user.client.ui.SimpleCheckBox implements HasResponsiveness, HasId,
     ...
     */
    public static SimpleCheckBoxUi wrap(Element element) {
        // Assert that the element is attached.
        assert Document.get().getBody().isOrHasChild(element);

        SimpleCheckBoxUi checkBox = new SimpleCheckBoxUi(InputElement.as(element));
    ...
    private final IdMixin<SimpleCheckBoxUi> idMixin = new IdMixin<SimpleCheckBoxUi>(this);
    private final PullMixin<SimpleCheckBoxUi> pullMixin = new PullMixin<SimpleCheckBoxUi>(this);
    private final EnabledMixin<SimpleCheckBoxUi> enabledMixin = new EnabledMixin<SimpleCheckBoxUi>(this);
     ...
     */
    protected SimpleCheckBoxUi(InputElement element) {
        super(element);
    }
