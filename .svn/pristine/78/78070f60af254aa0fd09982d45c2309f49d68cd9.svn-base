...
public class SuggestBox extends com.google.gwt.user.client.ui.SuggestBox implements HasId, HasResponsiveness, HasPlaceholder,
     ...
     */
    public SuggestBox(SuggestOracle oracle, ValueBoxBaseUi<String> box) {
     ...
     */
    public SuggestBox(SuggestOracle oracle, ValueBoxBaseUi<String> box, SuggestionDisplay suggestDisplay) {
