...
/**
 * This is the default {@link ErrorHandler} implementation. The assumption is that every {@link ValueBoxBaseUi}
...
public class DefaultErrorHandler implements ErrorHandler {
    ...
    public void init() {
        ...
        while (parent != null && !(parent instanceof com.google.gwt.user.client.ui.Widget)) {
